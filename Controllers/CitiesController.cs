...
namespace Assigment2WeatherData.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Country,Longitude,Latitude")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Country,Longitude,Latitude")] City city)
        {
            if (id != city.Id)
            {
                return NotFound();
